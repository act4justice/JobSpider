...
<script>
		...
		$(function() {
			...
			//자기 소개서 등록
            $('#saveOfCoverLetter').on('click', function() {
               var array = [];
	...
	<div id="wrapper">
            ...
            <div class="sidebar-collapse">
	                ...
	                <ul class="nav metismenu" id="side-menu">
	                    ...
	                    <li class="active">
	                        ...
	                        <ul class="nav nav-second-level">
	                            <li class="active" style="font-size:15px;"><a href="goInsertResumeForm">이력서/자소서 등록</a></li>
            	...
            	<c:if test="${not empty com_loginId }">
	                <ul class="nav metismenu" id="side-menu">
	                    <li class="nav-header">
	                        <div class="dropdown profile-element"> 
	                        	<a href="goTemp2"><span><img alt="image" class="img-circle" src="resources/img/logo_temp.png" /></span>
	                            <span class="clear"> 
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					<h2>
						이력서|자기소개서<small>&nbsp;&nbsp;Resume|Cover Letter</small>
					</h2>
									...
									<div class="panel-body">
										...
										<form id="submitForm" name ="submitForm" action="updatePerImage" method="post" enctype="multipart/form-data">
														...
														<div class="ibox float-e-margins">
															...
															<div class="ibox-content">
																...
																<table class="table table-bordered">
																	<tr>
																		<td rowspan="4" style="text-ailgn: center; vertical-align: bottom; padding: 25px;">
																			<canvas id="canvas" width="230px" height="300px"></canvas>
																		...
																		<tr class="edu_classTr">
																			<td>
																				<div class="input-group date">
																					...
																					<input type="text" name="edu_startdate" class="form-control edu_startdate" style="width: 98%;">
																				</div>&nbsp;~<br />
																				<div class="input-group date">
																					<span class="input-group-addon"><i class="fa fa-calendar"></i></span> 
																					<input type="text" name="edu_endadate" class="form-control edu_enddate" style="width: 98%;">
																				</div>
																			</td>
																			<td style="vertical-align: middle; text-align: center;"><input type="text" class="edu_scname" name="edu_scname"></td>
																			<td style="vertical-align: middle; text-align: center;"><input type="text" class="edu_major" name="edu_major"></td>
																			<td style="vertical-align: middle; text-align: center;"><input type="text" class="edu_graduation" name="edu_graduation"></td>
																		</tr>
																	</tbody>
																</table>
																	...
																	<tbody class="car_addTr">
																		<tr class="car_classTr">
																			<td>
																				<div class="input-group date">
																					<span class="input-group-addon"><i class="fa fa-calendar"></i></span> 
																					<input type="text" name="car_startdate" class="form-control car_startdate" style="width: 98%;">
																				</div>&nbsp;~<br />
																				<div class="input-group date">
																					<span class="input-group-addon"><i class="fa fa-calendar"></i></span> 
																					<input type="text" name="car_endadate" class="form-control car_enddate" style="width: 98%;">
																				</div>
																			</td>
																			<td style="vertical-align: middle; text-align: center;"><input type="text" class="car_comname" name="car_comname"></td>
																			<td style="vertical-align: middle; text-align: center;"><input type="text" class="car_department" name="car_department"></td>
																			<td style="vertical-align: middle; text-align: center;"><input type="text" class="car_duty" name="car_duty"></td>
																		</tr>
																	</tbody>
																</table>
																	...
																	<tbody class="cer_addTr">
																		<tr class="cer_classTr">
																			<td	style="vertical-align: middle; text-align: center;">
																				<input type="text" class="cer_cername" name="cer_cername">
																			</td>
																			<td>
																				<div class="input-group date">
																					<span class="input-group-addon">
																					<i class="fa fa-calendar"></i></span> 
																					<input type="text" class="cer_date" name="cer_date" class="form-control" style="width: 98%;">
																				</div>
																			</td>
																			<td><input type="text" class="cer_grade" name="cer_grade"></td>
																		</tr>
																	</tbody>
																</table>
																...
																<table class="table table-bordered">
																	...
																	<tbody class="awa_addTr">
																		<tr class="awa_classTr">
																			<td style="vertical-align: middle; text-align: center;">
																				<input type="text" class="awa_name" id="awa_name" name="awa_name">
																			</td>
																			<td style="vertical-align: middle; text-align: center;">
																				<input type="text" class="awa_detail" id="awa_detail" name="awa_detail">
																			</td>
																			<td>
																				<div class="input-group date">
																					<span class="input-group-addon"><i class="fa fa-calendar"></i></span> 
																					<input type="text" class="awa_date" id="awa_date" name="awa_date" class="form-control" style="width: 98%;">
																				</div>
																			</td>
																		</tr>
																	</tbody>
											...
											<div style="text-align: center;">
												<button type="button" class="btn btn-success btn-rounded btn-lg" id="resume">등록</button>
		                              ...
		                              <div class="form-group">
		                                 <div class="col-lg-12">
		                                    <div class="ibox float-e-margins">
		                                       ...
		                                       <form action="insertOfCoverLetter" method="post">
		                                          <!-- 자기 소개서 -->
		                                          <div class="col-lg-12">
		                                             <div class="ibox float-e-margins">
		                                                ...
		                                                <div class='addIntroFormInner'>
			                                                <div class="ibox-title">
			                                                   <input class="title" value="자기 소개" style="width:100%;border:none;border-right:0px; border-top:0px; boder-left:0px; boder-bottom:0px;"/>
			                                                </div>
			                                                <div class="ibox-content no-padding">
			                                                   <textarea class="contents" contenteditable="true" style=" width:100%; height:250px; border:none;border-right:0px; border-top:0px; boder-left:0px; boder-bottom:0px;"></textarea>
			                                                </div>
			                                            </div>
		                                                <!-- 자기 소개 -->
		                                                ...
		                                                <div class='addIntroFormInner'>
			                                                <div class="ibox-title">
			                                                   <input class="title" value="장점/단점" style="width:100%;border:none;border-right:0px; border-top:0px; boder-left:0px; boder-bottom:0px;"/>
			                                                </div>
			                                                <div class="ibox-content no-padding">
			                                                   <textarea class="contents" contenteditable="true" style=" width:100%; height:250px; border:none;border-right:0px; border-top:0px; boder-left:0px; boder-bottom:0px;"></textarea>
			                                                </div>
		                                                ...
		                                                <div class="addIntroForm">
		                                                   <div class="addIntroFormInner">
				                                                <div class="ibox-title">
				                                                   <input class="title" value="지원 동기" style="width:100%;border:none;border-right:0px; border-top:0px; boder-left:0px; boder-bottom:0px;"/>
				                                                </div>
				                                                <div class="ibox-content no-padding">
				                                                   <textarea class="contents" contenteditable="true" style=" width:100%; height:250px; border:none;border-right:0px; border-top:0px; boder-left:0px; boder-bottom:0px;"></textarea>
				                                                </div>
		                                                ...
		                                                <div style="text-align: center;">
		                                                   <button type="button"
		                                                      ...
		                                                      id="saveOfCoverLetter">등록</button>
		                                                   <a href="goTemp"><button type="button" class="btn btn-success btn-rounded btn-lg" id="goMain">메인</button></a>
		                                                </div>
		                                             </div>
		                                          </div>
