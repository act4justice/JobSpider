   ...
   <script>
      $(function() {
         ...
         $('.interest').on('click', function() {
               ...
               if (like == 'fa fa-star-o') {
                  $.ajax({
                     method : 'post',
                     url : 'registInterestRec',
                     data : data,
                     success : function(resp) {
                        target.attr('class', 'fa fa-star');
                     }
                  });
               } else{
                  $.ajax({
         ...
         $('#btn-apply').on('click', function(){
               ...
               $.ajax({
                  ...
                  data : data,
                  success : function(resp) {
                     location.replace('employInfoList_per');
                  },
                  error: function(){
                   ...
                   <ul class="nav metismenu" id="side-menu">
                       ...
                       <li class="active">
                           ...
                           <ul class="nav nav-second-level">
                               <li class="active" style="font-size:15px;"><a href="employInfoList_per">채용정보리스트</a></li>
              ...
              <c:if test="${r.dday > 0 }">
               <div class="col-lg-3">
                   <div class="contact-box center-version">
                       <a href="#" class="selectedInfo" recidx="${r.rec_index}" data-toggle="modal" data-target="#myModal5" style="padding: 0px">
                       ...
                       <div class="contact-box-footer">
                        ...
                        <c:if test="${r.like != true}">
                                  <a class="btn btn-white interest" rindex="${r.rec_index }" style="font-size: 15px;"><i class="fa fa-star-o"></i> 관심등록</a>
                               </c:if>
                               <c:if test="${r.like == true}">
                                  <a class="btn btn-white interest" rindex="${r.rec_index }" style="font-size: 15px;"><i class="fa fa-star"></i> 관심등록</a>
                               </c:if>
                           </div>
                       </div>
